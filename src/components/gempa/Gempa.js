...
export default function Gempa() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const resData = await axios.get(process.env.REACT_APP_API_KEY + "api/gempa", config)
                const resInfo = await axios.get('https://cuaca-gempa-rest-api.vercel.app/quake')
    ...
    return <div className='gempa-container'>
        <div className='kiri'>
        ...
        <div className='kanan'>
            <div className='info'>
                ...
                <table>
                    <tr>
                        <td><img src={Location} alt="Grow" width='50px' /><p>Wilayah</p></td>
                        <td><span>{info.wilayah}</span></td>
                    </tr>
                    <tr>
                        <td><img src={Quake} alt="Grow" width='50px' /><p>Potensi</p></td>
                        <td><span>{info.potensi} {info.dirasakan}</span></td>
                    </tr>
                </table>
            </div>
