            ...
            <div id="greetings">
                ...
                <form action="POST" id="search">
                    ...
                    <select name="provinsi" id="prov">
                        <option value="null" selected="selected">Provinsi</option>
                    </select>
                    <div></div>
                    <select name="kabupaten" id="kab">
                        <option value="null" selected="selected">Kabupaten</option>
                    </select>
